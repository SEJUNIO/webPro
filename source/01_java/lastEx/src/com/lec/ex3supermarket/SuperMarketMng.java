	...
	public static void main(String[] args) {
		...
		do {
			...
			case "2":
				...
				break;
			case "3":
				System.out.println("구매할 고객 아이디번호(아이디가 잘못 입력될 경우 구매불가)?");
			...
			case "5":
				...
				break;
			case "6":
				System.out.print("탈퇴할 전화번호는 ?");
				ctel = scanner.next();
				result = dao.deleteCustomer(ctel);
				System.out.println(result == CustomerDao.SUCCESS? "탈퇴완료" : "탈퇴실패");
				break;
			}
