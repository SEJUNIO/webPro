...
//InterfaceEx1 : CONSTANT_NUM, method1(추상) 
//InterfaceEx2 : CONSTANT_STRING, method2(추상)
public class TestMain {
	public static void main(String[] args) {
		...
		System.out.println("CONSTANT_STRING : " + InterfaceEx2.CONSTNAT_STRING);
		System.out.println("CONSTANT_STRING : " + ClassEx.CONSTNAT_STRING);
