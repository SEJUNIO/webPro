...
public class Ex01_HashMap {
	public static void main(String[] args) {
		...
		hashmap.put(11, "str1");   //put 다음 앞에는 키(11)값, 데이터(str1)값
		hashmap.put(11, "str11");  //haspmap 에서는 key값이 유일한값
		hashmap.put(12, "str12");
		hashmap.put(33, "str22");
		hashmap.put(20, "str20");
		System.out.println(11+ "key값의 데이터는 " + hashmap.get(11)); //데이터를 가져올때는 get()
		System.out.println(22+ "key값의 데이터는 " + hashmap.get(22)); //해당 key값이 없으면 null 
		hashmap.remove(33); //remove시 key 값으로 제거
