...
INSERT INTO BOOK (BID, BTITLE, BPRICE, BIMAGE1, BIMAGE2, BCONTENT, BDISCOUNT)
    VALUES (BOOK_SEQ.NEXTVAL, 'JSP 웹 프로그래밍', 30000, 'NOTHING.JPG', 'noImg.png',  '몰?루?', 15);
INSERT INTO BOOK (BID, BTITLE, BPRICE, BIMAGE1, BIMAGE2, BCONTENT, BDISCOUNT)
    VALUES (BOOK_SEQ.NEXTVAL, 'SPRING', 35000, 'NOTHING.JPG', 'noImg.png',  '몰?루?', 20);
INSERT INTO BOOK (bID, bTITLE, bPRICE, bIMAGE1, bIMAGE2, bCONTENT, bDISCOUNT)
...
SELECT ROWNUM RN, A.*
    FROM(SELECT * FROM BOOK ORDER BY BRDATE DESC) A; -- TOP-N 구문의 INLINE VIEW에 들어갈 쿼리
SELECT *
