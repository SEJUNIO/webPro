...
public class BookDao {
	...
	public int insertBook(BookDto dto) {
		...
		try {
			...
			pstmt.setString(5, dto.getBimage3());
	...
	public ArrayList<BookDto>listBook(){
		...
		try {
			...
			while(rs.next()) {
				 ...
				 String bimage3 = rs.getString("image3");
				 String bcontent = rs.getString("bcontent");
				 int bdiscount = rs.getInt("bdiscount");
				 Timestamp brdate = rs.getTimestamp("brdate");
				 books.add(new BookDto(bid, btitle, bprice, bimage1, bimage2, bimage3, bcontent, bdiscount, brdate));
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
	...
	public BookDto getBook(int bid) {
		...
		try {
			...
			if(rs.next()) {
				 ...
				 int bdiscount = rs.getInt("bdiscount");
				 Timestamp brdate = rs.getTimestamp("brdate");
				 book = new BookDto(bid, btitle, bprice, bimage1, bimage2, bimage3, bcontent, bdiscount, brdate);
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
