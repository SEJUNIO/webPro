...
<!--  requestScope.replyBoard(원글정보), param.bid, param.pageNum -->
	...
	<input type="hidden" name="bstep" value="${replyBoard.bstep}"> <!-- 원글 bstep -->
	<input type="hidden" name="bindent" value="${replyBoard.bindent}"> <!-- 원글 bindent -->
		<table>
			<caption>${param.bid}번 답변글쓰기</caption>
			<tr>
				<th>작성자</th>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" value="목록" class="btn" onclick="${conPath}/list.do?pageNum=${param.pageNum}">
				</td>
			</tr>
		</table>
	</form>
