	...
	<form action="${conPath}/modify.do" method="post" enctype="multipart/form-data">
		...
		<table>
			<caption>정보수정</caption>
				<tr>
				<th>아이디</th>
				<td><input type="text" name="mid" value="${member.mid }" size="3" readonly="readonly"></td>
				<td rowspan="4">
 				...
 				<tr>
 					<th>현비밀번호</th>
 					<td><input type="password" name="oldMpw" value="${member.mpw }" readonly="readonly" size="3"></td>
 				</tr>
