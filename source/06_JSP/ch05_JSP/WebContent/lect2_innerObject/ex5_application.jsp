...
<body>
 <%
 	...
 	String appPath = request.getContextPath();   // "/ch05_jsp"
...
<%
	String filePath = application.getRealPath("text/test.txt");
	out.println(filePath + "의 내용입니다<br>");
	// 1.스트림객체생성한다(파일을연다. 기본스트림->보조스트림) 2. 일고 화면출력 3.스트림닫는다(파일닫는다)
		Reader reader = null;
