...
CREATE TABLE BOARD (
    ...
    bTITLE VARCHAR2(100) NOT NULL,      -- 글 제목
    bCONTENT VARCHAR2(1000),             --글본문( VARCHAR2(4000)초가쇠 CLOB)
    bEMAIL VARCHAR2(50),                                -- 메일주소
    bHIT NUMBER(6) DEFAULT 0 NULL, -- 글조회수
    bPW VARCHAR2(50) NOT NULL,  -- 글 삭제시 쓸 비밀번호
    bGROUP NUMBER(6) NOT NULL,   -- 글 구룹(원글의 경우 글번호
    bSTEP NUMBER(3) NOT NULL,  -- 같은 글구룹 내의 출석 순*(원글O)
    bINDENT NUMBER(3) NOT NULL, -- 글 LIST출력시  글 제목 둘여쓰기 정도(원글ㅇ)
    bIP VARCHAR2(20) NOT NULL,  -- 글쓰기 요청한 컴퓨터 주소
...
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (BOARD_SEQ.NEXTVAL, '홍길동', '제목1', '냉무', NULL, '111', BOARD_SEQ.CURRVAL, 0, 0, '192.168.5.4');
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (BOARD_SEQ.NEXTVAL, '김길동', '제목2', '냉무', NULL, '0111', BOARD_SEQ.CURRVAL, 0, 0, '192.0.5.4');    
UPDATE BOARD SET BHIT = 11 WHERE BID=1;
...
INSERT INTO BOARD (BID, BNAME, BTITLE, BCONTENT, BEMAIL, BPW, BGROUP, BSTEP, bINDENT, BIP)
    VALUES (BOARD_SEQ.NEXTVAL, '김길동', '제목2', '냉무', 'K@K.COM', '0111', BOARD_SEQ.CURRVAL, 0, 0, '192.0.5.4');
