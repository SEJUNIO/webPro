...
//	// 싱글톤
//	private static MemberDaoCP instance = new MemberDaoCP();
//	public static MemberDaoCP getInstance() {
////		if(instance==null) {
...
//	}
	...
	private Connection getConnection() throws SQLException {
		...
		try {
			Context ctx = new InitialContext();//커넥션풀이용시 인폴트 javax.naming.Context; 일로 인포트
